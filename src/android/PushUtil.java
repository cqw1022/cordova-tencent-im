...
import com.sct.xgenban.MainActivity;
import com.sct.xgenban.R;
...
public class PushUtil implements Observer {
    ...
    private void PushNotify(TIMMessage msg) {
        Context context = IM.instance.cordova.getActivity().getApplicationContext();
        ...
        if (msg == null || Foreground.get().isForeground() ||
                ...
                msg.isSelf() ||
                msg.getRecvFlag() == TIMGroupReceiveMessageOpt.ReceiveNotNotify)//|| MessageFactory.getMessage(msg) instanceof CustomMessage)
            return;
...
//                .setNumber(++pushNum) //设置通知集合的数量
    ...
    public void reset() {
        NotificationManager notificationManager = (NotificationManager) IM.instance.cordova.getActivity().getApplicationContext().getSystemService(Context.NOTIFICATION_SERVICE);
