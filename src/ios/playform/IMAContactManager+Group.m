...
{
    NSMutableDictionary *myOwnDic = [NSMutableDictionary dictionary];
    NSMutableDictionary *myMgrDic = [NSMutableDictionary dictionary];
    NSMutableDictionary *myBelongToDic = [NSMutableDictionary dictionary];
    ...
    for (NSInteger i = 0; i < _groupList.count; i++)
    {
        ...
        if ([group isPublicGroup])
        {
            ...
            {
                [myOwnDic setObject:group forKey:group.groupId];
            }
            else if ([group isManagedByMe])
            {
                [myMgrDic setObject:group forKey:group.groupId];
            }
            else
            {
                [myBelongToDic setObject:group forKey:group.groupId];
            }
        }
    }
    
    NSArray *myOwn = [[myOwnDic allValues] mutableCopy];
    NSArray *myMgr = [[myMgrDic allValues] mutableCopy];
    NSArray *myBelongTo = [[myBelongToDic allValues] mutableCopy];
...
- (NSMutableArray *)chatRooms
{
    ...
    for (NSInteger i = 0; i < _groupList.count; i++)
    {
        ...
        if ([group isChatRoom])
        {
            [dic setObject:group forKey:group.groupId];
        }
    }
